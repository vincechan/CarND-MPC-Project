    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          Eigen::VectorXd ptsy_car(num_of_points);
          ...
          // fit the waypoints with polynomials
          ...
          */
          ...
          // use mpc to calcuate steering and acceleration
          // the first element in the result is steering, the second element in
          // the result is acceleration, the rest of the elements are x and y
          ...
          // populate points for reference line
          ...
          // populate points for predicted line
          ...
          // Display the MPC predicted trajectory, points are in reference to
          // the vehicle's coordinate system, the points in the simulator are
          // connected by a Green line
          msgJson["mpc_x"] = mpc_x_vals;
          msgJson["mpc_y"] = mpc_y_vals;

          // Display the waypoints/reference line, points are in reference to
          // the
